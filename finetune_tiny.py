...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='./checkpoints/biformer_tiny_in1k.pth', help='finetune from checkpoint')
    ...
    parser.add_argument('--output_dir', default='./out/tiny_cifar/', type=str,
