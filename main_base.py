...
# Fix NotImplementedError: cannot instantiate 'PosixPath' on your system
import platform
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='biformer_base', type=str, metavar='MODEL',
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='./checkpoints/pre/biformer_base_in1k.pth', help='finetune from checkpoint')
    ...
    parser.add_argument('--output_dir', default='./out/base_cifar/', type=str,
...
def main(args):
    ...
    if args.finetune:
        ...
        # Fix for KeyError: 'pos_embed' not found
